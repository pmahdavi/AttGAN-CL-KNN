...
class condGANTrainer(object):
    def __init__(self, output_dir, data_loader, n_words, ixtoword, dataset, optim):
        if cfg.TRAIN.FLAG:
        ...
        self.n_coef = cfg.TRAIN.NCOEF #PM
        self.opt_type = optim #pm
    ...
    def define_optimizers(self, netG, netsD): #pm
        optimizersD = []
        ...
        for i in range(num_Ds):
            if self.opt_type == 'adam':
                opt = optim.Adam(netsD[i].parameters(),
                                ...
                                betas=(0.5, 0.999))
            elif self.opt_type == 'adam_nm': 
                opt = my_adam_nm(netsD[i].parameters(), lr=cfg.TRAIN.OPTIM.DISCRIMINATOR_LR, betas=cfg.TRAIN.OPTIM.BETAS)
            else: 
                raise NameError('The optimizer is not specified')
        ...
        if self.opt_type == 'adam':
            ...
            optimizerG = my_adam_nm(netG.parameters(), lr=cfg.TRAIN.OPTIM.GENERATOR_LR, betas=cfg.TRAIN.OPTIM.BETAS)
    ...
    def train(self):
        ...
        for epoch in range(start_epoch, self.max_epoch):
            ...
            while step < self.num_batches:
                ...
                ######################################################
                data = data_iter.next()
                imgs, imgs_n, imgs_2, captions, cap_lens, class_ids, keys, captions_2, cap_lens_2, class_ids_2, \
                sort_ind, sort_ind_2 = prepare_data(data) #pm
                ...
                for i in range(len(netsD)):
                    ...
                    errD_3 = discriminator_loss(netsD[i], imgs_n[i], fake_imgs[i],
                            sent_emb_2, real_labels, fake_labels) #pm
                    
                    errD = errD + errD_2 +  self.n_coef * errD_3    #pm
        ...
        if cfg.TRAIN.NET_G == '':
            ...
            for ii in range(1):  # (cfg.TEXT.CAPTIONS_PER_IMAGE):
                ...
                for step, data in enumerate(self.data_loader, 0):
                    ...
                    sort_ind, sort_ind_2 = prepare_data_n(data)
